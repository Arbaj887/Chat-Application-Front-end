...
useEffect(()=>{
        async function global(){
         const global = await axios.post("http://localhost:8000/GetFriendRequest",{email})
...
const rejectFriend=async (e,friendEmail)=>{
  ...
  try {
     await axios.post(`http://localhost:8000/RejectFriendRequest`,{friendEmail,email});
...
const acceptFriend= async (e,friendEmail)=>{
    ...
    try {
       ...
       const c= await axios.post(`http://localhost:8000/AcceptFriendRequest`,{friendEmail,email});
